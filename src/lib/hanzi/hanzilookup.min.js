...
HanziLookup.MatchCollector = function (r) {
    ...
    function e(r) {
        if (!((c == u.length && r.score <= u[u.length - 1].score) || t(r))) {
            for (var e = n(r.score), o = u.length - 1; o > e; --o)
                u[o] = u[o - 1];
            ((u[e] = r), c < u.length && ++c);
        }
    }
    ...
    (HanziLookup.Matcher = function (o, n) {
        ...
        function a(o, n, a) {
            ...
            for (var e = [], _ = 0; _ != o.analyzedStrokes.length; ++_)
                for (
                    var C = o.analyzedStrokes[_], T = 0;
                    T != C.subStrokes.length;
                    ++T
                )
        ...
        function u() {
            for (
                var o = HanziLookup.MAX_CHARACTER_SUB_STROKE_COUNT + 1,
                    n = [],
                    a = 0;
                a < o;
                a++
            ...
            for (var t = 0; t < n.length; t++)
                for (
                    ...
                    if (Math.abs(t - C) <= a) {
                        ...
                        var H =
                                p[t][C + 1] -
                                (i / 256) * HanziLookup.SKIP_PENALTY_MULTIPLIER,
                            k =
                                p[t + 1][C] -
                                (L / 256) * HanziLookup.SKIP_PENALTY_MULTIPLIER,
                            h = Math.max(H, k),
                            M = _(u, i, S, L, e, R),
                            O = p[t][C];
                        T = Math.max(O + M, h);
...
// Export for Next.js/ESM compatibility
if (typeof module !== 'undefined' && module.exports) {
    module.exports = HanziLookup;
}
export { HanziLookup as default };
export const init = HanziLookup.init;
export const Matcher = HanziLookup.Matcher;
export const AnalyzedCharacter = HanziLookup.AnalyzedCharacter;
