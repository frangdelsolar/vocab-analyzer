...
import { useProgress } from '@/context/ProgressContext'; // Import new context
import { Card, CardContent, Typography, Button } from '@/components/ui';
import { IdentitySettings, StatusSelect } from './IdentitySettings'; // Move to separate file for cleanliness
